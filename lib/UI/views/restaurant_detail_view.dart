...
class RestaurantDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider(
          create: (context) =>
              RestaurantBloc()..add(RestaurantDetailGet(restaurant!.id)),
          child: BlocConsumer<RestaurantBloc, RestaurantState>(
            builder: (context, state) {
              ...
              } else if (state is RestaurantDetailGetSuccess) {
                return Center(
                    child: ListView(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              fit: BoxFit.cover,
                              image: NetworkImage(
                                  "https://restaurant-api.dicoding.dev/images/large/${state.detailRestaurant.pictureId}"))),
                    ),
                    Padding(
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                  flex: 5,
                                  child: Text(
                                    "${state.detailRestaurant.address}, ${state.detailRestaurant.city}",
                                    style: Theme.of(context)!
                                        .textTheme
                                        .titleMedium
                                        ?.copyWith(
                                  ...
                                  Flexible(
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: ((context, index) {
                                        final Category restCategories = state
                                ...
                                children: [
                                  Expanded(
                                      child: ListView.builder(
                                          shrinkWrap: true,
                                          scrollDirection: Axis.horizontal,
                                          itemCount: state.detailRestaurant
                                              .menus.foods.length,
                                          itemBuilder: ((context, index) {
                                            var menus = state.detailRestaurant
                                                .menus.foods[index];
                                            return Column(
                                                mainAxisAlignment:
            ...
            listener: (context, state) {
              if (state is RestaurantDetailGetSuccess) {
